...
Most of these come down to network reality or how mitnews serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

mitnews rate-limits like any public site. mit already paces
...
Where a surface is gated, mit reads a cookie or token you supply
...
`mit`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what mit actually did
